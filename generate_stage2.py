#!/usr/bin/env python3
"""
Generate Stage 2 DOCX document for Weld landing page overhaul.
This script uses the docx library to create a professional technical specification document.
Run: python generate_stage2.py
"""
...
def main():
    ...
    # Problems
    doc.add_heading("The Problem with Current Typography", level=2)
    problems = [
    ...
    # Change 1
    doc.add_heading("Change 1: The LuaU Code Block Component", level=2)
    doc.add_paragraph(
    ...
    doc.add_heading("Component Specifications", level=3)
    specs = [
    ...
    # Syntax table
    doc.add_heading("Syntax Color Palette", level=3)
    table = doc.add_table(rows=7, cols=3)
    table.style = 'Light Grid Accent 1'
    hdr_cells = table.rows[0].cells
    hdr_cells[0].text = "Token Type"
    ...
    # Code example
    doc.add_heading("Example LuaU Code", level=3)
    code = [
        "-- weld_auth.luau",
        "local WeldProfile = {}",
        "",
    ...
    # Change 2
    doc.add_heading("Change 2: The Studio Output Panel", level=2)
    doc.add_paragraph("The hero boot sequence currently looks generic. It should look like the Roblox Studio Output window. Key changes:")
    ...
    # Output colors table
    doc.add_heading("Output Colors by Severity", level=3)
    ...
    # Boot sequence
    doc.add_heading("New Boot Sequence Format", level=3)
    boot_lines = [
    ...
    # Change 3
    doc.add_heading("Change 3: Explorer Tree Typography for Role Explorer", level=2)
    doc.add_paragraph(
    ...
    doc.add_heading("Tree Panel Design", level=3)
    tree_design = [
        "Font: monospace, 11px, tighter line-height",
        "Each role becomes a \"folder\" node with an arrow indicator",
    ...
    for t in tree_design:
        doc.add_paragraph(t, style='List Bullet')

    # Tree structure
    doc.add_heading("Tree Structure", level=3)
    tree = [
        " Workspace",
    ...
    # Change 4
    doc.add_heading("Change 4: Information Density & Font Sizing", level=2)
    doc.add_paragraph("Current font sizes are too generous. The page breathes too much for a tool aimed at developers. Proposed changes:")
    ...
    # Change 5
    doc.add_heading("Change 5: Kill the Shimmer, Add Targeted Glow", level=2)
    doc.add_paragraph(
    ...
    # Implementation
    doc.add_heading("Implementation Order", level=2)
    impl = [
    ...
    # Effort
    doc.add_heading("Effort & Impact", level=2)
    doc.add_paragraph(
    ...
    # Save
    output_path = r"C:\Users\cubit\Downloads\Weld-app\stage2_typography.docx"
